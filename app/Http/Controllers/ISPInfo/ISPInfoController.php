...
class ISPInfoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // 3️⃣ Return response
        return redirect()->back()->with('success', 'School Internet info saved successfully!');
    }
    ...
    public function update(Request $request, int $id)
    {
        ...
        if (! $schoolInternet) {
            return redirect()->back()->with('error', 'School Internet info not found.');
        }
        $schoolInternet->update($validated);

        // 3️⃣ Return response
        return redirect()->back()->with('success', 'School Internet info updated successfully!');
    }

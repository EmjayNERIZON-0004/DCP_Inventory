                                 ...
                                 <div class="py-1 flex flex-row gap-4">
                                     ...
                                     <div class="mt-1   flex flex-row gap-2  " style="height: fit-content">
                                         <button type="button"
                                             ...
                                             class="px-2 shadow-md flex items-center py-1  ml-auto bg-blue-500 text-white text-md rounded-sm hover:bg-blue-600 transition-all m-0">
                                         ...
                                         <button type="button"
                                             ...
                                             class="px-2 flex items-center shadow-md  py-1 bg-red-600 hover:bg-red-700 text-md text-white rounded-sm transition-all
                                                            m-0">
                                             <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                 <path stroke-linecap="round" stroke-linejoin="round"

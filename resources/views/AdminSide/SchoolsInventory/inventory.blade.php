...
@section('content')
    ...
    <div class="mx-5 my-5">
        ...
        <div class="mb-4 text-gray-600  " style="font-family: Verdana, Geneva, Tahoma, sans-serif">Select a school to filter
            items, or view all by default.</div>
            ...
            <form method="GET" action="{{ route('index.SchoolsInventory') }}"
                ...
                <div>
                    <div class="text-gray-700 font-medium text-lg  "
                        style="font-family: Verdana, Geneva, Tahoma, sans-serif">School</div>
                ...
                <div class="w-full    ">
                    <div class=" text-gray-700 font-medium text-lg"
                        style="font-family: Verdana, Geneva, Tahoma, sans-serif">Budget Year</div>
                    <select name="budget_year" onchange="this.form.submit()"
                        class="border border-gray-800 px-3 py-2 w-full rounded"
                        style="font-family: Verdana, Geneva, Tahoma, sans-serif">
            ...
            @foreach ($school_items as $batch)
                <div class="bg-white border border-blue-500 shadow rounded p-4 mb-4" x-data="{ open: false }">
                    <div class="flex justify-between cursor-pointer" @click="open = !open">
                        ...
                        <div>
                            <a href="#top"
                                class="text-blue-600 hover:text-blue-800 underline flex items-center space-x-1" @click.stop>
                    ...
                    <div class="flex gap-2">
                        <div class="bg-blue-200 text-gray-900 border text-[Verdana] border-gray-800 px-4 py-2 rounded-sm">
                            <b>{{ $batch['items']->count() }}</b> - Items
                            ...
                            @foreach ($batch['items'] as $item)
                                <tr class="hover:text-blue-700 ">
                                    ...
                                    <td class="py-2 px-5 flex justify-center">
                                        ...
                                        @endphp
                                        <div
                                            class=" w-full py-1 hover:no-decoration text-gray-800 border border-gray-800  px-2 rounded text-center

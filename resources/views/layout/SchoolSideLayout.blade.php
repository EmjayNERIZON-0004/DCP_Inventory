    ...
    <div class="bg-white border-b border-gray-200">
        <div class="flex flex-wrap gap-2 justify-center sm:justify-start px-2 py-2">
            ...
            <a href="{{ route('school.dashboard') }}"
                class="px-4 
          {{ Request::is('School/dashboard') ? '  text-blue-900 font-bold underline' : '' }}
          py-2 font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">Home</a>
            <a href="{{ route('school.profile') }}"
                class="px-4 py-2 
                   {{ Request::is('School/profile') ? '  text-blue-900 font-bold underline' : '' }}
            ...
            <a href="{{ route('school.dcp_batch') }}"
                class="px-4 py-2 
                   {{ Request::is('School/dcp-batch') ? '  text-blue-900 font-bold underline' : '' }}
                font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">DCP Batch Profile</a>

            <a href="{{ route('school.dcp_service_report') }}"
                class="px-4 py-2
                   {{ Request::is('School/dashboard') ? '  text-blue-900 font-bold underline' : '' }}
                font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">DCP Service Report</a>
            <a href="{{ route('school.dcp_inventory') }}"
                class="px-4 py-2 
                   {{ Request::is('School/dcp-inventory') ? '  text-blue-900 font-bold underline' : '' }}
                font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">DCP Inventory</a>
            <a href="{{ route('school.dcp_documents') }}"
                class="px-4 py-2 
                   {{ Request::is('School/dashboard') ? '  text-blue-900 font-bold underline' : '' }}
                font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">DCP Documents</a>
            <a href="{{ route('school.ict_slac') }}"
                class="px-4 py-2
                   {{ Request::is('School/dashboard') ? '  text-blue-900 font-bold underline' : '' }}
                font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">ICT SLAC</a>
            <a href="{{ route('school.manual') }}"
                class="px-4 py-2 
                   {{ Request::is('School/dashboard') ? '  text-blue-900 font-bold underline' : '' }}
                font-semibold text-blue-700 hover:underline hover:text-blue-900 transition-all duration-200"
                style="width: fit-content;">Manual</a>
        </div>
    </div>

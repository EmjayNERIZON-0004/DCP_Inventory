            ...
            @if (Auth::guard('school')->user() && Auth::guard('school')->user()->school)
                ...
                <div class="grid md:grid-cols-4   grid-cols-1 md:gap-4 gap-2">
                    <div id="school_others" style="border:1px solid #ccc"
                        class="bg-white col-span-3 rounded-md shadow-md overflow-hidden p-6 mt-6">
                    ...
                    <div style="border:1px solid #ccc;width:100%"
                        class="w-full bg-white  rounded-md shadow-md overflow-hidden p-6 mt-6">
                        <div>
                            <h3 class="text-2xl font-semibold text-blue-700 ">More Details</h3>
                        ...
                        <form class="w-full" action="{{ route('school.submit.non_teaching') }}" method="POST">
                            ...
                            @method('POST')
                            <div>
                                <label for="total_no_teaching">No. of Non-Teaching Staff</label>
                                <input class="border border-gray-300 rounded px-2 py-1 w-full"
                                    value="{{ Auth::guard('school')->user()->school->total_no_teaching ?? '' }}"
                                    type="text" name="total_no_teaching">
                            </div>

                            <div>
                                <label for="classroom_with_tv">No. of Classrooms with TV </label>
                                <input class="border border-gray-300 rounded px-2 py-1 w-full"
                            ...
                            <div class="flex justify-end">
                                ...
                                <button class="bg-blue-500 hover:bg-blue-700 text-white px-4 py-1 mt-2 rounded"
                                    type="submit">

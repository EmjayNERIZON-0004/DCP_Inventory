                                 ...
                                 @foreach ($isp_content as $index => $content)
                                     <tr>
                                         ...
                                         <td class="py-2 px-2 border border-gray-300 py-2 text-center " style="width: 20%">
                                             @php
                                                 $content->isp_purpose_id = App\Models\ISP\ISPPurpose::where(
                                                     'pk_isp_purpose_id',
                                                     $content->isp_purpose_id,
                                                 )->value('name');

                                             @endphp
                                             {{ $content->isp_purpose_id ?? '' }}</td>
                                         <td class="py-2 px-2 border border-gray-300 py-2 text-center">
                                         ...
                                         <td class="py-2 px-2 border border-gray-500 py-2 text-center">
                                             ...
                                             <button type="button" onclick="deleteISP({{ $content->id }})"
                                                 class="text-red-600 underline hover:text-red-800">Remove</button>
                                         </td>

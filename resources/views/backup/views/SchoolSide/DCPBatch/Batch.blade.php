                        ...
                        <tr class="hover:bg-blue-50 transition">
                            ...
                            <td class="px-2 py-3 md:px-4 space-x-2 border border-gray-300">
                                <a href="{{ route('school.dcp_items', $b->id ?? $b->pk_dcp_batches_id) }}"
                                    class=" flex items-center gap-2 text-md  bg-blue-200 text-gray-800 px-2 py-1   rounded hover:bg-blue-600  hover:text-white border border-gray-800">
                            ...
                            <td class="px-4 py-3 border border-gray-300 ">
                                ...
                                <div class="text-left">
                                    ...
                                    text-md {{ $bg_color }} text-gray-800 px-2 py-1
                                ...
                                @if (!$b->approval?->status)
                                    <form action="{{ route('submit.dcp_batch') }}" method="POST">
                                        ...
                                        <button {{ $status !== 'Completed' ? 'disabled' : '' }}
                                            class="bg-blue-500 hover:bg-blue-600 {{ $status !== 'Completed' ? 'cursor-not-allowed opacity-50' : '' }} text-white py-1 px-4 rounded">Submit</button>
                                    </form>
                                @else
                                    @php
                                        $text_color = '';
                                    ...
                                    @endphp
                                    <span
                                        class="{{ $text_color }} font-normal text-lg">{{ $b->approval?->status }}</span>
                                @endif
                            </td>

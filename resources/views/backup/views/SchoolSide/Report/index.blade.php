 ...
 @section('content')
     ...
     @if (!$batches->isEmpty())
         ...
         <div id="printArea" class="bg-white my-2 mx-5  p-6    border border-gray-300 rounded-lg shadow-md">
             ...
             {{-- SCHOOL PROFILE --}}
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold">School Profile</div>
                 <hr>
             ...
             {{-- current statistics --}}
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold">Current Statistics</div>
                 <hr>
             ...
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold">School Personnel</div>
                 <hr>
             ...
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold">Internet Internet Connectivity: </div>

                 @if ($ISP->isEmpty())
                     <div class="text-center  text-md font-normal text-gray-600">No ISP Details Available.</div>
                 @else
                     <div class="grid grid-cols-1 justify-center gap-4 mt-2">
                         @foreach ($ISP as $isp_details)
                             <div class="border border-gray-300 px-4 py-2 ">
             ...
             {{-- DCP DELIVERIES --}}
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold">DCP Deliveries </div>
                     ...
                     <tbody>
                         @foreach ($batches as $index => $batch)
                             <tr class="border border-gray-300 px-5 py-1">
                                 ...
                                 <td class="px-5 "> {{ $batch->batch_label }}</td>
                                 <td class="px-5"> {{ $batch->budget_year }}</td>
                                 <td class="px-5"> {{ $batch->delivery_date }}</td>
                                 {{-- <td class="px-5">  1</td> --}}
                                 @php
                                 ...
                                 @endphp
                                 <td class="px-5  whitespace-nowrap">&#8369; {{ number_format($batch_items_price, 2) }}
                                 </td>
                                 <td class="px-5">Functional: {{ $total_functional }} out of {{ $total_items }}
                                     ({{ $percentage }}%)
                                 </td>
                                 <td class="px-5"> No Status Available</td>
                                 <td class="px-5"> None</td>
             ...
             {{-- DCP STATUS --}}
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold mb-2">DCP Status</div>
                 @foreach ($batches as $index => $batch)
                     @php
                         ...
                         //  }
                     @endphp
                     <div class="text-lg text-gray-700 font-bold">Batch: {{ $batch->batch_label }}</div>
                         ...
                         <tbody>
                             @foreach ($batch_items as $typeId => $items)
                                 ...
                                 <tr>
                                     ...
                                     <td class="border px-2 py-1 whitespace-nowrap">₱{{ $unitPrice }}</td>
             ...
             {{-- NON DCP ITEMS  --}}
             <div class="mb-10">
                 <div class="text-lg text-gray-700 font-bold">Non DCP Items</div>
                 <table class="w-full border-collapse border text-md">
                     ...
                     @foreach ($non_dcp as $item)
                         <tr>
                             ...
                             <td class="border px-2 py-1 ">{{ $item->date_acquired }}</td>

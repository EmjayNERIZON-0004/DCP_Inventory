 ...
 @section('content')
     ...
     <div class="grid md:grid-cols-3 grid-cols-1 md:gap-4 gap-2 mx-5 mb-10">
                                         ...
                                         <div class="py-1 flex flex-row gap-4">
                                             ...
                                             <div class="mt-1   flex flex-row gap-2  " style="height: fit-content">
                                                 ...
                                                 <button type="button"
                                                     ...
                                                     class="px-6  py-1 bg-red-600 hover:bg-red-700 text-sm text-white rounded-sm transition-all
                                                            m-0">Delete</button>
                                             </div>
                                     </td>
                                 </tr>

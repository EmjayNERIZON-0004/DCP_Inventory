...
@section('content')
    ...
    <div id="create-modal-overlay"
        ...
        <div id="create-form-section"
            ...
            <form id="create-form" action="{{ route('store.package_type') }}" method="POST"> @csrf
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white   py-1 px-2 rounded">Create New
                    Package
                </button>
    ...
    <div id="edit-modal-overlay"
        ...
        <div id="edit-form-section"
            class="bg-white shadow-xl rounded-lg overflow-hidden p-6 border border-yellow-500 w-full max-w-5xl relative">
    ...
    <div class="bg-white   border border-gray-400 shadow-xl rounded-lg overflow-hidden p-6 mx-5 my-5"
        ...
        <div class="flex justify-between">
            <div>
                <h2 class="text-2xl font-bold  text-gray-700"> DCP Packages Offered</h2>
            ...
            ">
                <thead>
                    <tr>
                        ...
                        <th class="bg-gray-700">Unit Price</th>
                        ...
                        @foreach ($items as $index => $package)
                            <tr>
                                ...
                                <td
                                    ...
                                    {{ number_format($package->unit_price, 2) }}
                                </td>
                                <td
                                    style="border: 1px solid #282828; background-color: {{ $color }};text-align:center">
                                    {{ $package->quantity }}
                                ...
                                <td
                                    ...
                                    <div class="flex gap-2 flex-col md:flex-row" style="width: fit-content;  ">
                                        <button type="button" style="border: 1px solid black"
                                            ...
                                            '{{ $package->unit_price }}' // Pass brand ID here
                                                  )"

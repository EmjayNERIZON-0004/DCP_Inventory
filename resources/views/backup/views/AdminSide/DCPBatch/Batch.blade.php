...
@section('content')
    ...
    <div class="bg-white   border border-gray-400 shadow-xl rounded-lg overflow-hidden p-6 mx-5 my-5"
        ...
        <div class="flex justify-between  ">
            ...
            <div> <button type="button" onclick="showAddBatchModal()"
                    class="bg-blue-600 hover:bg-blue-700 text-white py-1 h-10 px-4 rounded mb-4">
                    Add DCP Batch
                </button></div>
                ...
                <tbody id="batchTableBody" class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach ($dcpBatches as $batch)
                        <tr id="row-{{ $batch->pk_dcp_batches_id }}" class="hover:bg-blue-50 transition">
                            ...
                            <td class="px-4 py-3 border-r border-gray-200">{{ $batch->school_name ?? 'N/A' }} -
                                {{ $batch->school_level }}</td>

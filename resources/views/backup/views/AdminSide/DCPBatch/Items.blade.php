            ...
            <table id="table_item" class="min-w-full border border-gray-400 text-sm text-left border border-gray-200"
                ...
                <thead class="bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-white ">Item Price</th>
                    ...
                    @foreach ($groupedItems as $typeId => $group)
                        ...
                        @foreach ($group as $index => $item)
                            <tr class="{{ $bg }}">
                                ...
                                @if ($index === 0)
                                    <td class="px-4 py-3 font-bold text-gray-900 border-r border-gray-400 align-top"
                                        rowspan="{{ $rowspan }}">
                                ...
                                <td class="px-4 py-3 border-r border-gray-400">{{ number_format($item->unit_price, 2) }}
                                </td>
                                ...
                                @endphp
                                <td class="px-4 py-3 border-r border-gray-400">{{ $brandName ?? 'N/A' }}</td>
                                <td class="px-4 py-3 border-r border-gray-400">{{ $item->serial_number ?? 'N/A' }}</td>
                            </tr>
                        @endforeach
                    @endforeach

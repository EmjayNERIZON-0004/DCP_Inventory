...
@section('content')
    ...
    <div class="bg-white border border-blue-500 shadow-xl rounded-lg overflow-hidden p-6 mx-5 my-5">
        <div class="flex justify-between items-center text-md" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
            <div>
                <h2 class="text-2xl font-bold text-gray-700  " style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
                    School
                </h2>
                <div class="text-md text-gray-600  mb-5">List of Schools under DepEd Computerization Program</div>
            </div>
            <div>
                <button class="bg-blue-600 hover:bg-blue-700 text-md text-white py-2 px-4 rounded"
                    onclick="openAddModal()" type="button">Create
                    School</button>
        ...
        <div class="overflow-x-auto">
            <table class="w-full md:text-md lg:text-sm sm:text-lg text-left  border border-gray-300"
                style="font-family: Verdana, Geneva, Tahoma, sans-serif;">
                <thead class="bg-gray-700">
                    <tr>
                        <th class="px-4 py-3 font-semibold whitespace-nowrap uppercase tracking-wider text-white   ">
                            School ID</th>
                        <th class="px-4 py-3 font-semibold  whitespace-nowrap uppercase tracking-wider text-white   ">
                            Logo </th>
                        <th class="px-4 py-3 font-semibold  whitespace-nowrap uppercase tracking-wider text-white   ">
                        ...
                        <th class="px-4 py-3 font-semibold whitespace-nowrap  uppercase tracking-wider text-white   ">
                            School Level</th>
                        {{-- <th class="px-4 py-3 whitespace-nowrap font-semibold uppercase tracking-wider text-white   "> --}}
                        {{-- School Head</th>
                        <th class="px-4 py-3 whitespace-nowrap font-semibold uppercase tracking-wider text-white   ">
                            School Contact</th> --}}
                        <th class="px-4 py-3 font-semibold  whitespace-nowrap uppercase tracking-wider text-white   ">
                    ...
                    @foreach ($schools as $school)
                        <tr class="hover:bg-blue-50 transition" id="row-{{ $school->pk_school_id }}">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 border-r border-gray-200">
                                <img class="  object-cover rounded-full" style="width: 120px;"
                            ...
                            <td class="px-4 py-3 border-r border-gray-200">
                                ...
                                @endphp
                                {{ \Carbon\Carbon::parse($user_login)->format('F j, Y, g:iA') }}
                            </td>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-col gap-2 items-stretch">
                                    <a href="{{ route('schools.show', $school->pk_school_id) }}"
                                        class="px-3 py-1  font-normal text-white bg-blue-600 rounded hover:bg-blue-700 text-center">Details</a>
                                    <button
                                        ...
                                        class="px-3 py-1  font-normal text-white bg-yellow-400 rounded hover:bg-yellow-500 text-center">
                                        Edit
                                    </button>


                                    <button type="button" onclick="deleteSchool('{{ $school->pk_school_id }}')"
                                        class="px-3 py-1  font-normal text-white bg-red-600 rounded hover:bg-red-700 text-center">Delete</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        rows =
                            `<tr><td colspan="8" class="text-center text-gray-500 px-4 py-3">No results found.</td></tr>`;
                    }

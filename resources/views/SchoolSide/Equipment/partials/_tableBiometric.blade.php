             ...
             <div class="mb-6">
                 ...
                 <table class="w-full border-collapse">
                     <tbody>
                         ...
                         {{-- ROW 1 --}}
                         <tr>
                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Brand /
                                 Model</td>
                             ...
                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Date
                                 Installed</td>
                             <td class="border border-gray-500 px-3 py-2">
                         ...
                         {{-- ROW 2 --}}
                         <tr>
                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">No. of
                                 Biometrics</td>
                             <td class="border border-gray-500 px-3 py-2">
                                 {{ $info->no_of_units ?? '' }}
                             </td>

                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Functional
                                 Biometrics</td>
                             <td class="border border-gray-500 px-3 py-2">
                                 {{ $info->no_of_functional ?? '' }}/{{ $info->no_of_units ?? '' }}
                             </td>

                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Power
                                 Source</td>
                             <td class="border border-gray-500 px-3 py-2">
                         ...
                         {{-- ROW 3 --}}
                         <tr>
                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Location
                             </td>
                             <td class="border border-gray-500 px-3 py-2">
                                 {{ $info->equipment_details->location->name ?? '' }}
                             </td>

                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Installer
                             </td>
                             <td class="border border-gray-500 px-3 py-2">
                                 {{ $info->equipment_details->installer->name ?? '' }}
                             </td>

                             <td class="bg-gray-100 border border-gray-500 px-3 py-2 font-semibold">Person
                                 In-Charge</td>
                             <td class="border border-gray-500 px-3 py-2">

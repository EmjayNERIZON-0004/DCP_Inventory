  ...
  @section('content')
      ...
      <div id="add-employee-modal"
          ...
          <div class="modal-content bg-white px-4 py-1 my-5 mx-5 rounded-md">
      ...
      <div id="edit-employee-modal"
          class="modal inset-0 fixed overflow-y-auto bg-black bg-opacity-40 flex items-start justify-center z-50 hidden">
          <div class="modal-content bg-white px-5 py-4 my-5 mx-5 rounded-md w-full max-w-4xl">
                          ...
                          <td colspan="8" class="h-5">
                              <div class="mb-5 mt-1 flex flex-row gap-2">
                                  ...
                                  <button onclick="delete_employee('{{ $emp->pk_schools_employee_id }}')"
                                      class="text-red-500 border border-red-500 hover:bg-red-600 hover:text-white text-sm py-1 px-4 tracking-wider font-medium rounded shadow">
                                      Remove Employee
                                  </button>
                              </div>
                          </td>

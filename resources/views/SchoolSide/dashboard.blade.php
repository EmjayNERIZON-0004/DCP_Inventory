...
@section('content')
    ...
    <div class="py-5 px-4 ">
        <div
            class="bg-white mb-4 p-6 flex items-center justify-between border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
            <!-- Left: Title -->
            <div>
            ...
            <!-- Right: Logo -->
            <div>
                <img class="h-32 shadow-md w-auto rounded-lg object-contain" src="{{ asset('icon/header.png') }}"
                    alt="SDO Logo">
            </div>
        </div>
        ...
        <div
            ...
            <div class="w-full   ">
                ...
                <div class="mt-4 flex gap-2">
                    <div class="text-gray-800 text-md border border-gray-800 bg-green-200 px-3 py-1 rounded-sm">Under
                        Warranty
                        Items
                        <div class="text-center text-xl font-bold"> {{ $total_under_warranty }}</div>
                    </div>
                    <div class="text-gray-800 text-md border border-gray-800 bg-red-200 px-3 py-1 rounded-sm">Out of
                        Warranty
                        Items
                        <div class="text-center text-xl font-bold"> {{ $total_out_of_warranty }}</div>
                    </div>
                </div>
            ...
            <div
                class="max-w-full w-full   bg-white shadow-lg mt-4 border border-gray-500 rounded-lg p-4 border border-gray-200">

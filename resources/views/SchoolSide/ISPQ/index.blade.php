...
@section('content')
    <div class="p-6 flex flex-col gap-3">
        <div class="flex justify-start mb-2 space-x-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-gray-800">Schools Internet Report</h2>
                <h2 class="font-normal text-lg text-gray-600">Answer the following questions</h2>
        ...
        <table class=" border border-gray-300 tracking-wider bg-white w-full border border-gray-300 shadow-md p-4">
            <thead>
                <tr class="bg-gray-300 border border-gray-500">
                    <th class=" uppercase px-2 py-1">No.</th>
                    <th class=" uppercase px-2 py-1">Question</th>
                    <th class=" uppercase px-2 py-1">Answer(s)</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($isp_question as $question)
                    <tr>
                        <td class="border border-gray-500 bg-gray-100  px-4 py-1 font-semibold text-center">
                            {{ $loop->iteration }}</td>
                        <td class="border border-gray-500 px-4 py-1 font-semibold">{{ $question->question_text }}</td>
                        <td class="border border-gray-500 px-4 py-1">

         ...
         <form method="POST" action="{{ route('SchoolEquipment.store') }}">
             ...
             <div class="flex flex-col items-center justify-center gap-0">
                 ...
                 <div class="text-center">
                     <div class="text-2xl font-bold text-gray-700  ">Equipment Information</div>
                     <div class="text-md text-blue-600 mb-4">Encode the information needed for the equipment</div>
                 </div>
             </div>
     ...
     <div class="modal-content bg-white p-4 px-5 my-5 mx-5 rounded-md">
         ...
         <form id="editEquipmentForm" method="POST">
             ...
             <div class="flex flex-col items-center justify-center gap-0">
                 ...
                 <div class="text-center">
                     <div class="text-2xl font-bold text-gray-700  ">Edit Equipment Information</div>
                     <div class="text-md text-green-600 mb-4">Encode the information needed for the equipment</div>
                 </div>
             </div>

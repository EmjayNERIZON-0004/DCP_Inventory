         ...
         <form action="{{ route('schools.isp.store') }}" method="POST">
             ...
             <div class="flex flex-col items-center justify-center gap-0">
                 ...
                 <div class="text-center">
                     <div class="text-2xl font-bold text-gray-700  ">Internet Service Provider</div>
                     <div class="text-base text-blue-600 mb-4">Information of School's Internet</div>
                 </div>
             </div>
                 ...
                 <div>
                     <div
                         ...
                         <button title="Show Edit Modal" type="button" onclick="closeISPDetailsModal()"
                             class="btn-cancel whitespace-nowrap h-8 py-1 px-4 rounded-full">
                             Cancel
                         </button>
                     </div>
                 </div>
         ...
         <div>
             <form action="{{ route('schools.isp.update') }}" class="mt-2" method="POST">
                 ...
                 <div class="flex flex-col items-center justify-center gap-0">
                     ...
                     <div class="text-center">
                         <div class="text-2xl font-bold text-gray-700  ">Update Internet Service Provider</div>

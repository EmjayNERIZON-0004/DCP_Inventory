  ...
  @section('content')
      <div id="add-employee-modal"
          ...
          <div class="modal-content bg-white px-4 py-1 mx-5 rounded-md">
              <form action="{{ route('schools.employee.store') }}" method="POST">
                  ...
                  <div>
                      <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white  py-1 px-4 rounded">Save
                          Employee</button>
                      <button type="button" onclick="closeModal()"
                          class="bg-gray-500 hover:bg-gray-700 text-white   py-1 px-4 rounded">Cancel</button>
                  </div>
              </form>
      ...
      <div id="edit-employee-modal"
          ...
          <div class="modal-content bg-white px-4 py-1 mx-5 rounded-md">
              <form action="{{ route('schools.employee.update') }}" method="POST">
                  ...
                  <div>
                      <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white  py-1 px-4 rounded">Update
                          Employee</button>
              ...
              fetch("get-data")
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 12H6" />
                      ...
                      items.forEach(item => {
                          ...
                          card.className =
                              "p-4 rounded-xl shadow-lg border border-gray-300 bg-white flex items-center gap-4 hover:shadow-xl transition";

                          card.innerHTML = `
                                <div class="w-12 h-12 flex items-center justify-center ${item.color} text-white rounded-lg">
                                    ${item.icon}
                                </div>
                                <div>
      ...
      <div class="my-5 mx-5 bg-white shadow-xl rounded-lg overflow-hidden p-6 border border-gray-300">
              ...
              <div>
                  ...
                  <div class="d-flex justify-content-end mb-3">
                      <button onclick="openModal()" type="button"
                          class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-1 px-4 rounded w-fit">Add
                          Employee
                      </button>
          ...
          <div>
              <table class="w-full  table-auto border-collapse" id="employeeTable">
                  @foreach ($employee as $emp)
                      <tr>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Name</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Sex</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Birthdate</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Employee Number</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Position Title</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Salary Grade</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Deped Email</td>
                      </tr>
                      ...
                      <tr>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Deped Email Status</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">M365 Email Status</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Canva Login Status</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">LR Portal Status</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">L4T Recipient</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">Smart TV Recipient</td>
                          <td class="px-4 py-1 bg-gray-200 border border-gray-500">L4NT Recipient</td>
                      </tr>
                      ...
                      <tr>
                          <td colspan="2" class="h-5  ">
                              <div class="mb-5 mt-1 flex flex-row gap-2">
                                  <button
                                      class="border border-blue-500 text-blue-500 hover:bg-blue-700 hover:text-white text-sm font-semibold py-1 px-4 rounded"
                                  ...
                                  <button onclick="delete_employee('{{ $emp->pk_schools_employee_id }}') "
                                      class="text-red-500 border border-red-500 hover:bg-red-600 hover:text-white text-sm font-semibold py-1 px-4 rounded">Remove
                                      Employee</button>
                              </div>
                          </td>
                      </tr>

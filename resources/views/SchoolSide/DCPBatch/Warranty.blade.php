...
@section('content')
    <div class="mx-auto max-w-7xl px-4 py-5 font-[Verdana]">
        @if ($warranties->count())
            <div class="flex flex-col justify-center items-center">

                @foreach ($warranties as $warranty)
                    {{-- <a href="{{ route('school.dcp_item_status', $warranty->batchItem->dcpBatch->pk_dcp_batches_id) }}"
                        class="inline-flex items-center  text-blue-600 w-1/2 text-left text-md font-semibold hover:underline">
                    ...
                    <div class="border-1 md:w-1/2 w-full">
                    ...
                    <div
                        class="bg-white md:w-1/2 w-full border border-gray-300 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                        <!-- Item Type -->
                        ...
                        <!-- Start / End Dates -->
                        <div class="grid grid-cols-2 gap-1 text-md text-center mb-3">

    ...
    @if ($batch_approved === null)
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden p-6 mx-5 my-5">
            ...
            <div class="flex justify-between">
                <h2 class="text-2xl font-bold text-gray-800  ">Items for Batch: {{ $batch->batch_label ?? '' }}</h2>
                <button type="button" onclick="printAllQRCodes()"
                    class="   text-blue-600 font-[Verdana] text-lg  underline hover:text-blue-700 mb-4">
                    Print All QR Codes
                </button>
            </div>

...
@section('content')
    <div class="bg-white shadow-xl rounded-lg overflow-hidden p-6 mx-5 my-5">
        <h2 class="text-2xl font-bold text-gray-800 mb-4" style="font-weight: 600">My DCP Batches</h2>
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm text-left border border-gray-200" style=" font-weight: 600;font-size: 16px ">
                <thead style="background: #2563eb;">
                    <tr>
                        <th class="px-4 py-3 font-bold uppercase tracking-wider text-white border-r border-blue-700">
                            Batch Label</th>
                        <th class="px-4 py-3 font-bold uppercase tracking-wider text-white border-r border-blue-700">
                            Package Type</th>
                        <th class="px-4 py-3 font-bold uppercase tracking-wider text-white border-r border-blue-700">
                        ...
                        <tr class="hover:bg-blue-50 transition">
                            ...
                            <td class="px-4 py-3 space-x-2">
                                <a href="{{ route('school.dcp_items', $b->id ?? $b->pk_dcp_batches_id) }}"
                                    ...
                                    class="inline-block px-3 py-2 text-xs font-semibold text-white bg-blue-500 rounded hover:bg-blue-600">
                                    Show Items
                                </a>
                            </td>
                        </tr>
